"""adding the tables from models.py

Revision ID: d93970c3b342
Revises: 419fc3a96d49
Create Date: 2022-07-18 14:29:06.784575
...
revision = 'd93970c3b342'
down_revision = '419fc3a96d49'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['owner_id'], ['users_login.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
